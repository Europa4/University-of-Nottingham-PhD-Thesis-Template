...
\title{Non-equilibrium Quantum Simulations using Thimble Methods}

\author{Simon J. Woodward}
\submitdate{July 2021}
\degree{Doctor of Philosophy}
\studentid{4311477}
\supervisor{Paul Saffin \\ Antonio Padilla}
...
\input{2-Contours/Contours}
\input{3-Thimble Methods/Thimble_methods}
\input{4-Equilibrium Simulations/Equilibrium_Simulations}
\input{Initial Conditions and Density Matricies/Initial_conditions}
